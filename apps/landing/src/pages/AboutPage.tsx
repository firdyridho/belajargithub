              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
                <div className="p-6 bg-surface rounded-xl border border-outline-variant flex flex-col gap-4">
                  <span className="font-display-lg text-display-lg-mobile text-primary">
                    <CountUp to={2026} from={2000} duration={2.5} />
                  </span>
                  <span className="font-label-caps text-label-caps text-on-surface">Establishment</span>
                </div>
                <div className="p-6 bg-surface rounded-xl border border-outline-variant flex flex-col gap-4">
                  <span className="font-display-lg text-display-lg-mobile text-green-guild flex items-center">
                    <CountUp to={50} from={0} duration={2.0} />+
                  </span>
                  <span className="font-label-caps text-label-caps text-on-surface">Active Members</span>
                </div>
                <div className="p-6 bg-surface rounded-xl border border-outline-variant flex flex-col gap-4">
                  <span className="font-display-lg text-display-lg-mobile text-red-team">
                    <CountUp to={12} from={0} duration={1.5} />
                  </span>
